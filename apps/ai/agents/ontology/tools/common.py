...
"nothing happened" for "nothing was wrong", and a failure arrives as a typed `error`
field rather than as a stack trace to parse.
...
invocation rather than the one tool call.
"""
